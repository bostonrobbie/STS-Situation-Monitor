...
See **[INSTALL.md](INSTALL.md)** for full desktop deployment instructions (Windows, macOS, Linux).
...
- **Geo** — Geolocation events, heatmaps, geofence management
- **Semantic** — Vector search via Qdrant embeddings
- **Export** — CSV, JSON, and PDF report exports
...
|---|---|
| [`INSTALL.md`](INSTALL.md) | Complete desktop deployment guide (Windows/macOS/Linux) |
